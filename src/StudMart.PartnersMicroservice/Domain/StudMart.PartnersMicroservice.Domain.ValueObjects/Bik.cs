...
public class Bik : SingleParameterValueObjectBase<string>
{
    private Bik(string value, IValidator<string> validator) : base(value, validator)
    {
    }

    public Bik(string bik) : this(bik, new BikValidator())
    {
