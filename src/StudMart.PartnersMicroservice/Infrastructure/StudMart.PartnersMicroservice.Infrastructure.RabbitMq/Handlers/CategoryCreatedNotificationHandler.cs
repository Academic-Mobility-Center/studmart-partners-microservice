...
public class CategoryCreatedNotificationHandler(IOptions<RabbitSettings> options, IMapper mapper)
    : CreatedNotificationHandlerBase<CategoryCreatedNotification, CategoryModel, CategoryServiceModel>(options, mapper,
        "AddCategory");